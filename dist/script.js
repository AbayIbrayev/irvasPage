...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      modal = document.querySelectorAll('[data-modal]'); //allowing only numbers for the phone number inputs using regex

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); //object of messages to display while the POST request is happening
