...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      phoneInputs = document.querySelectorAll('input[name="user_phone"]'); //allowing only numbers for the phone number inputs using regex
...
var modals = function modals() {
  ...
  bindModal('.phone_calc_button', '.popup_calc', '.popup_calc_close'); // showModalByTime('.popup', 60000);
};
